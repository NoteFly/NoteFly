...
cp -r ./builddeb ~/notefly-builddeb/notefly-2.0.0rc1_all/
sudo chmod 755 -R ~/notefly-builddeb/

##sudo chmod 644 ~/notefly-builddeb/usr/bin/langs.xml
sudo chmod 644 ~/notefly-builddeb/notefly-2.0.0rc1_all/usr/share/doc/notefly/changelog
sudo chmod 644 ~/notefly-builddeb/notefly-2.0.0rc1_all/usr/share/doc/notefly/copyright
...
sudo dpkg-deb --build ~/notefly-builddeb/notefly-2.0.0rc1_all/

# checking if it's done all right.
lintian -c ~/notefly-builddeb/notefly-2.0.0rc1_all.deb
